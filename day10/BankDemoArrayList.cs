...
public class ArrayListBank : IBank 
{
	...
	public IAccount FindAccount (string name)
	{
		...
		for (position = 0; position < bankArrayList.Count; position++) 
		{
			// Da in der ArrayList nur Referenzen gespeichert
			// werden, müßen wir die Referenz in einer realen
			// Variablen zwischenspeichern und auch
			// einen expliziten Typecast vornehmen.
			Account accounts = (Account) bankArrayList[position];
  ...
  static void Main ()
	{
		...
		IBank DieGrosseBank = new ArrayListBank();
